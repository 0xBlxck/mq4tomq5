//+------------------------------------------------------------------+
//|                                                      
//|                                      Copyright 2023,heyycoucoutoi|
//|                                         arthurcolombe34@gmail.com|
//+------------------------------------------------------------------+
#property copyright "2023.";
#property link "arthurcolombe34@gmail.com"
...
int init() {
   ...
   I_b_5 = false;
   I_b_43 = true;
   I_s_9 = "ACCOUNT ANDA BELUM TERDAFTAR! UNTUK DIPAKAI DI LIVE ACCOUNT";
   int L_i_15;
   L_i_15 = 0;
...
int start() {
   ...
   */
   ...
   ObjectSetText("j", "SmartBot", 19, "Times New Roman Bold", 65280);
   S_s_20 = "\nLisensi t.me/SmartBot69 \n================================\nINFORMATION:\n  Nama Broker " + AccountCompany();
   S_s_20 = S_s_20 + "\n";
   S_s_20 = S_s_20 + "================================";
   S_s_20 = S_s_20 + "\n";
